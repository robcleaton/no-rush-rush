...
const RUDE_WORDS = [
  // Rude words (prioritised — appear most often)
  'ARSE','ARSEHOLE','BASTARD','BELLEND','BITCH','BLOODY','BOLLOCKS','BONK',
  'BUGGER','BUMHOLE','CLUNGE','COCK','COCKUP','CRAP','CUNT','DICKHEAD',
  'DIPSTICK','FANNY','FART','FATARSE','FILTH','FLANGE','FRIG','FUCK',
  'FUCKER','FUCKUP','GIT','GOBSHITE','GROTTY','GUFF','JOBBY','KNOB',
  'KNOBBER','KNOBEND','MINGE','MINGER','NONCE','NUMPTY','PANTS','PILLOCK',
  'PISS','PISSED','PLONKER','PRAT','PRICK','SHIT','SHITE','SHITHEAD',
  'SKANK','SLAG','SLAPPER','SLOB','SNOG','SOD','SPUNK','TART','TITS',
  'TOSSER','TURD','TWAT','TWIT','WANK','WANKER','WAZZOCK','WILLY',
  // Rude words (prioritised — appear most often)
  'ARSE','ARSEHOLE','BASTARD','BELLEND','BOLLOCKS','BUGGER','COCK','CRAP',
  'CUNT','DICKHEAD','FANNY','FUCK','FUCKER','GIT','GOBSHITE','KNOB',
  'MINGE','NUMPTY','PILLOCK','PISS','PLONKER','PRAT','SHIT','SHITE',
  'SHITHEAD','TOSSER','TWAT','WANK','WANKER','WAZZOCK',
  // British slang from Urban Dictionary
  'BAIT','BARE','BLADDERED','BLINDING','BODGE','BONKERS','BUFF','BUTTERS',
  'CHANCER','CHAV','CLAPPED','CODSWALLOP','CRACKING','DAFT','DENCH',
  'DODGY','DOSS','EEJIT','FAFF','FIT','FLUMMOXED','GEEZER','GOBSMACKED',
  'GORMLESS','GROTTY','GUTTED','HAMMERED','INNIT','JAMMY','KERFUFFLE',
  'KNACKERED','LASHED','LEGLESS','MALARKEY','MANKY','MARDY','MIFFED',
  'MORTAL','MULLERED','MUPPET','NARKY','NICKED','NUTTER','PENG','RANK',
  'RINSED','SCRAN','SICK','SKINT','SLOSHED','SORTED','SOZZLED','SPANNER',
  'SQUIFFY','STEAMING','STROPPY','TROLLIED','TWIT','WALLY','WELLIED',
